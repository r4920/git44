...
db.patient = require('./patient')(dbConnection);

db.note = require('./note')(dbConnection);

db.order = require('./order')(dbConnection);

db.enterprise = require('./enterprise')(dbConnection);

db.medication = require('./medication')(dbConnection);

db.departments = require('./departments')(dbConnection);

db.encounter = require('./encounter')(dbConnection);

db.Customer = require('./Customer')(dbConnection);

db.Task = require('./Task')(dbConnection);

db.Comment = require('./Comment')(dbConnection);

db.Plan = require('./Plan')(dbConnection);

db.Chat_group = require('./Chat_group')(dbConnection);

db.Chat_message = require('./Chat_message')(dbConnection);

db.ToDo = require('./ToDo')(dbConnection);

db.Appointment_schedule = require('./Appointment_schedule')(dbConnection);

db.Appointment_slot = require('./Appointment_slot')(dbConnection);

db.Event = require('./Event')(dbConnection);

db.Master = require('./Master')(dbConnection);

db.Blog = require('./Blog')(dbConnection);
