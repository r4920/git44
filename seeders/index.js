...
async function seedUser () {
  try {
    ...
    userToBeInserted = await userDbService.findOne({ 'username':'Gaetano_Hackett' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'UmNjRVWIuIFjdnp',
        'isDeleted':false,
        'username':'Gaetano_Hackett',
        'email':'Alycia.Kassulke73@hotmail.com',
        'isActive':true,
      ...
      await userDbService.update({ 'username':'Gaetano_Hackett' }, userToBeInserted);
    }
    userToBeInserted = await userDbService.findOne({ 'username':'Micah.Ortiz' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'72h2e8S50TodR4K',
        'isDeleted':false,
        'username':'Micah.Ortiz',
        'email':'Dewitt44@gmail.com',
        'isActive':true,
      ...
      userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
      await userDbService.update({ 'username':'Micah.Ortiz' }, userToBeInserted);
    }
